...
/**
 * libh2o_http_server moudle init, will init all resources for libh2o_http_server
...
/**
 * libh2o_http_server moudle stop, will stop work thread for libh2o_http_server and
 ...
 * user need alloc response header/body buffers from req->req->pool, and will freed when response sent finish by h2o.
 */
